...
//==============================================================================
VCGainEditor::VCGainEditor(VCGainProcessor& p)
...
// Paint
//==============================================================================
void VCGainEditor::paint(Graphics& g)
{
    // Background
    ...
    g.drawFittedText("VC-Gain", 15, 15, getWidth() - 30, 30,
