...
//==============================================================================
VC-DynamicEQEditor::VC-DynamicEQEditor(VC-DynamicEQProcessor& p)
...
VC-DynamicEQEditor::~VC-DynamicEQEditor()
{
}
...
// Paint
//==============================================================================
void VC-DynamicEQEditor::paint(Graphics& g)
{
    // Background
    ...
    g.drawFittedText("VC-DynamicEQ", 15, 15, getWidth() - 30, 30,
...
// Resize
//==============================================================================
void VC-DynamicEQEditor::resized()
{
    //============================================================================
