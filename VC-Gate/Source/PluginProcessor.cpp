...
//==============================================================================
VC_GateProcessor::VC_GateProcessor()
    : AudioProcessor(BusesProperties()
                     .withInput("Input", AudioChannelSet::stereo())
                     .withOutput("Output", AudioChannelSet::stereo()))
    , mAPVTS(*this, nullptr, Identifier("VC-GateParameters"),
...
VC_GateProcessor::createParameterLayout()
{
...
// Prepare to Play
//==============================================================================
void VC_GateProcessor::prepareToPlay(double sampleRate, int samplesPerBlock)
{
...
void VC_GateProcessor::releaseResources()
{
    mDSP.reset();
}
...
//==============================================================================
bool VC_GateProcessor::isBusesLayoutSupported(const BusesLayout& layouts) const
{
...
// Process Audio Block
//==============================================================================
void VC_GateProcessor::processBlock(AudioBuffer<float>& buffer,
                                     MidiBuffer&)
{
    if (mBypass)
        return;
...
//==============================================================================
void VC_GateProcessor::parameterChanged(const String& parameterID,
                                         float newValue)
{
...
// State Information
//==============================================================================
void VC_GateProcessor::getStateInformation(MemoryBlock& destData)
{
...
void VC_GateProcessor::setStateInformation(const void* data,
                                            int sizeInBytes)
{
...
// Create Editor
//==============================================================================
AudioProcessorEditor* VC_GateProcessor::createEditor()
{
    return new VC_GateEditor(*this);
}
