// VC-Delay CLI - JUCE-based Command Line Tool
...
void printHelp(const char* progName) {
    std::cout << "VC-Delay CLI - Stereo Delay Tool\n\n";
...
int main(int argc, char** argv) {
    ...
    std::cout << "VC-Delay CLI (JUCE Version)\n";
    ...
    if (args.count("--time")) {
        ...
        std::cout << "Delay Time: " << params.delayTime << " ms\n";
    }
    ...
    std::unique_ptr<juce::AudioFormatWriter> writer(
        wavFmt.createWriterFor(
            ...
            32,  // bits per sample
            {},  // metadata - MUST be StringPairArray
            0    // quality
        )
    );
